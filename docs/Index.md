# The Low Level Journey - Documentation

Bienvenido al diario de desarrollo de nuestro "Viaje al Bajo Nivel".
Aquí documentamos cada paso, cada crash y cada bit aprendido.

## Índice

### Fase 0: El Despertar
- [00. Herramientas del Oficio](00_herramientas.md) (NASM, QEMU)
- [01. El Primer Aliento: Boot Sector](01_boot_sector.md) ("Hola Mundo" en x86)

### Fase 1: Teoría Fundamental
- [02. Arquitecturas: La Torre de Babel](02_arquitecturas.md) (x86 vs ARM)
- [03. ¿Todo acaba en Ensamblador?](03_compilacion.md) (De Python al Metal)
- [04. Nombres Perdidos (Symbols)](04_simbolos.md) (Debugging y Hex)
